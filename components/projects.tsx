...
const projects: Project[] = [
  { id: "1", titleUp: "Node", titleDown: "Health", image: "/img/mock-project1.webp", description: "Monitor liveness, uptime, missed rounds, version status, and multi-environment connectivity in a single operator-first dashboard." },
  { id: "2", titleUp: "Rewards", titleDown: "Analytics", image: "/img/mock-project2.webp", description: "Track daily earnings, compare against network performance, understand reward composition, and prepare exports for accounting workflows." },
  { id: "3", titleUp: "Comms", titleDown: "Hub", image: "/img/mock-project3.webp", description: "Replace scattered chat threads with auditable announcements, upgrade notices, support tickets, and readiness confirmations." },
];
    ...
    <section id="projects" className="projects bg-background relative py-24">
      ...
      <div className="pb-16">
        <VelocityText baseVelocity={80} className="text-[clamp(4rem,12vw,14rem)] font-medium italic tracking-tight text-foreground uppercase px-8">
          Core <span className="font-serif font-thin">Modules</span>&nbsp;
        </VelocityText>
      </div>
