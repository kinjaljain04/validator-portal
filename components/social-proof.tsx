      ...
      <div className="px-6 sm:px-12 lg:px-24 max-w-360 2xl:max-w-450 3xl:max-w-550 mx-auto">
        <div ref={headerRef} className="flex items-center justify-between mb-12 lg:mb-16">
          <h2 className="text-3xl lg:text-4xl font-medium tracking-tight text-foreground">
            Built for network-scale validator operations
          </h2>
          <Link
            href="#projects"
        ...
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:grid-rows-[minmax(220px,auto)_minmax(220px,auto)_minmax(180px,auto)]">
          <div className="row-span-2 flex flex-col gap-4">
            ...
            <div className="relative flex-1 w-full overflow-hidden rounded-full">
              <Image
                ...
                alt="Canton infrastructure operations"
                fill
                className="object-cover"
              />
            </div>
          ...
          <div className="lg:col-span-2 row-span-2 bg-muted/50 rounded-2xl p-8 flex flex-col">
            <div>
              ...
              <blockquote className="text-2xl lg:text-3xl font-medium leading-snug text-foreground">
                Validators are Canton&apos;s core infrastructure. They store contract data, execute code, validate transactions, and earn Canton Coin for keeping the network alive.
              </blockquote>
              <div className="mt-6">
                <p className="font-semibold text-foreground">Validator Portal Thesis</p>
                <p className="text-sm text-foreground/60">Operational layer for Canton infrastructure</p>
              </div>
            </div>
            <div className="flex items-center justify-between mt-auto pt-8">
              <span className="text-xl font-semibold text-foreground">Canton Network</span>
              <Link
                href="#about"
          ...
          <div className="bg-muted/50 rounded-2xl p-6 flex flex-col">
            <div className="flex-1">
              <p className="text-3xl font-semibold text-foreground">980+</p>
              <p className="text-sm text-foreground/60 mt-1">Active validators on the network</p>
            </div>
            <div className="flex items-center justify-between mt-auto pt-4">
              <span className="text-sm font-medium text-foreground">operator footprint</span>
              <Link
                href="#hero"
                className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center hover:bg-foreground hover:text-background transition-colors"
              >
          ...
          <div className="bg-muted/50 rounded-2xl p-6 flex flex-col">
            <div className="flex-1">
              <p className="text-3xl font-semibold text-foreground">24x</p>
              <p className="text-sm text-foreground/60 mt-1">Institutional expansion since early network launch</p>
            </div>
            <div className="flex items-center justify-between mt-auto pt-4">
              <span className="text-sm font-medium text-foreground">network expansion</span>
              <Link
                href="#about"
                className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center hover:bg-foreground hover:text-background transition-colors"
              >
          ...
          <div className="bg-muted/50 rounded-2xl p-8 flex flex-col">
            <div className="flex-1">
              <p className="text-3xl lg:text-4xl font-semibold text-foreground">$6T+</p>
              <p className="text-foreground/60 mt-2">
                Tokenized assets<br />secured on Canton
              </p>
            </div>
            <div className="mt-auto pt-6">
              <p className="text-sm font-medium text-foreground">600k+ daily transactions across the network</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 bg-muted/50 rounded-2xl p-8 flex flex-col">
            <p className="text-xl lg:text-2xl font-medium leading-relaxed text-foreground max-w-3xl flex-1">
              Institutional operators already in the Canton validator set include Goldman Sachs, HSBC, BNP Paribas, Circle, Chainlink, Binance.US, Crypto.com, Gemini, Kraken, P2P.org, Kiln, and Tradeweb.
            </p>
            <div className="flex items-center justify-between mt-auto pt-6">
              <span className="text-xl font-semibold text-foreground">Institutional validator set</span>
              <Link
                href="#contact"
                className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center hover:bg-foreground hover:text-background transition-colors"
              >
