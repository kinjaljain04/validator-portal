...
const sections = [
  ...
  { id: "validator-wall", label: "Validators" },
        ...
        >
          <div className="mx-auto flex max-w-360 items-center justify-between gap-4 2xl:max-w-450 3xl:max-w-550">
            ...
            <div className="relative h-12 sm:h-16">
              <motion.div
                className="absolute top-0 right-0 w-56 overflow-hidden rounded-xl bg-neutral-900/70 shadow-lg backdrop-blur-lg sm:w-72 sm:rounded-2xl"
                initial={{ opacity: 0, y: -20 }}
                animate={{
                  opacity: 1,
                  y: 0,
              ...
              >
                ...
                >
                  <span className="text-base font-medium sm:text-lg">{activeSection}</span>
                  <motion.div
