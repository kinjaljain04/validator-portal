...
const services = [
  { id: 1, title: "Multi-environment monitoring" },
  { id: 2, title: "Reward tracking and exports" },
  { id: 3, title: "Foundation communication" },
  { id: 4, title: "Upgrade readiness workflows" },
  { id: 5, title: "Compliance and profile management" },
  { id: 6, title: "Public validator leaderboard" },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <SplitText>One workspace for node health, rewards, communication, and validator operations.</SplitText>
        </h2>
      </div>
